...
import {
    ...
    findInsertPosition,
    findProcessionData,
    findlastValueBalance,
    findlastValidBalance,
    createInsertData,
    updateExistData,
} from "../libs/helper"
...
const addRebate = (rebateData) => {
    ...
    // console.log(beforeTrans.length)
    let idx = findInsertPosition(transArr, rebateDate)
    console.log("idx =>>. ", idx)
    console.log("findlastValueBalance ==> ", findlastValueBalance(idx, transArr))
    // console.log("lastbalance ==> ", findlastValidBalance(idx, transArr))
    // const lastBeforeTrans = findlastValueBalance(beforeTrans)
    // const createTrans = createInsertData(
    //     `rebate`,
    //     lastBeforeTrans.balance,
    //     lastBeforeTrans.orderNb + 1,
    //     rebateData.amount,
    //     lastBeforeTrans.fees,
    //     rebateDate,
    //     lastBeforeTrans.freq
    // )
